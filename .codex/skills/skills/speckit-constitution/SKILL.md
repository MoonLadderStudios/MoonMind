...
3. Draft the updated constitution content:
   ...
   - Ensure Governance section lists amendment procedure and compliance review expectations.
...
5. Produce a Sync Impact Report (prepend as an HTML comment at top of the constitution file after update):
   - Governance metadata changes (ratified/last-amended fields, if any)
...
8. Output a final summary to the user with:
   ...
   - Suggested commit message (e.g., `docs: amend constitution principles and governance guidance`).
...
If the user supplies partial updates (e.g., only one principle revision), still perform validation steps.
