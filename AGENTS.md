...
- Do not introduce internal ID aliases, display-name matching, provider-specific synonyms, compatibility translation tables for these identities. Rename by updating every caller, test, mock, seed, and doc reference in the same change.
