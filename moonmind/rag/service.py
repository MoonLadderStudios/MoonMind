...
class ContextRetrievalService:
    ...
    def retrieve(
        ...
        *,
        ...
        # qdrant-client, so it cannot satisfy the Qdrant-free requirement).
        # Retrieval merges planning (Beads, explicit-reference) and vector
        # items only; there is no long-term-memory branch.
