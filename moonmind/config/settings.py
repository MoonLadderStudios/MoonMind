...
class SpecWorkflowSettings(BaseSettings):
    ...
    git_user_name: Optional[str] = Field(
        None,
        env=("WORKFLOW_GIT_USER_NAME", "MOONMIND_GIT_USER_NAME"),
        validation_alias=AliasChoices(
            "WORKFLOW_GIT_USER_NAME", "MOONMIND_GIT_USER_NAME"
        ),
        description="Optional Git author/committer display name used by worker publish stages.",
    )
    git_user_email: Optional[str] = Field(
        None,
        env=("WORKFLOW_GIT_USER_EMAIL", "MOONMIND_GIT_USER_EMAIL"),
        validation_alias=AliasChoices(
            "WORKFLOW_GIT_USER_EMAIL", "MOONMIND_GIT_USER_EMAIL"
        ),
