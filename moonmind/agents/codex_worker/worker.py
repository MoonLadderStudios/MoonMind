        ...
        default_skill = (
            str(
                source.get(
                    ...
                    source.get(
                        "WORKFLOW_DEFAULT_SKILL",
                        source.get("MOONMIND_DEFAULT_SKILL", "auto"),
                    ),
                )
            ).strip()
            or "auto"
...
class CodexWorker:
    ...
    def _execution_metadata(
        ...
        used_fallback = any(skill != "auto" for skill in selected_skills)
        if not used_skills:
            selected_skill = "auto"
            ...
            execution_path = (
                "skill" if selected_skill == "auto" else "direct_fallback"
            )
        else:
        ...
        *,
        ...
        if step.effective_skill_id != "auto":
            ...
            return await self._codex_exec_handler.handle_skill(
                ...
                selected_skill=step.effective_skill_id,
                fallback=step.effective_skill_id != "auto",
                cancel_event=cancel_event,
