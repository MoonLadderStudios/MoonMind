...
class CodexExecHandler:
    ...
    def _derive_default_pr_body(
        ...
        *,
        ...
        runtime_value = cls._normalize_publish_text_line(runtime_mode) or "codex"
        base_value = cls._normalize_publish_text_line(base_branch) or "unknown"
        head_value = cls._normalize_publish_text_line(head_branch) or "unknown"
        lines = [
