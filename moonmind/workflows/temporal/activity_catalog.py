...
def build_default_activity_catalog(
    ...
    activities = (
        ...
        TemporalActivityDefinition(
            activity_type="checkpoint_branch.turn.mark_running",
        ...
        TemporalActivityDefinition(
            activity_type="checkpoint_branch.turn.persist_terminal",
            family="checkpoint_branch_turn",
            capability_class="workflow",
            task_queue=workflow_task_queue,
            fleet=WORKFLOW_FLEET,
        ...
        # ---- MoonMind.OmnigentSession bounded, idempotent, fenced activities ----
        # See docs/Temporal/ManagedAndExternalAgentExecutionModel.md and issue
        # MoonLadderStudios/MoonMind#3705. Each has a bounded StartToClose timeout
        # and executes exactly one durable logical command; provider event reads
        # return a bounded batch/timeout rather than occupying the worker.
        TemporalActivityDefinition(
            activity_type="omnigent.resolve_intent",
            family="omnigent_session",
            capability_class="workflow",
            task_queue=workflow_task_queue,
            fleet=WORKFLOW_FLEET,
            timeouts=TemporalActivityTimeouts(30, 60),
        ...
        TemporalActivityDefinition(
            activity_type="omnigent.ensure_provider_profile_lease",
            family="omnigent_session",
            capability_class="workflow",
            task_queue=workflow_task_queue,
            fleet=WORKFLOW_FLEET,
        ...
        TemporalActivityDefinition(
            activity_type="omnigent.ensure_host",
            family="omnigent_session",
            capability_class="workflow",
            task_queue=workflow_task_queue,
            fleet=WORKFLOW_FLEET,
            timeouts=TemporalActivityTimeouts(300, 360),
            retries=_activity_retries(max_attempts=3, max_interval_seconds=30),
        ),
        TemporalActivityDefinition(
            activity_type="omnigent.ensure_provider_session",
            family="omnigent_session",
            capability_class="workflow",
            task_queue=workflow_task_queue,
            fleet=WORKFLOW_FLEET,
        ...
        TemporalActivityDefinition(
            activity_type="omnigent.submit_turn",
            family="omnigent_session",
            capability_class="workflow",
            task_queue=workflow_task_queue,
            fleet=WORKFLOW_FLEET,
        ...
        TemporalActivityDefinition(
            activity_type="omnigent.read_event_batch",
            family="omnigent_session",
            capability_class="workflow",
            task_queue=workflow_task_queue,
            fleet=WORKFLOW_FLEET,
        ...
        TemporalActivityDefinition(
            activity_type="omnigent.observe_snapshot",
            family="omnigent_session",
            capability_class="workflow",
            task_queue=workflow_task_queue,
            fleet=WORKFLOW_FLEET,
        ...
        TemporalActivityDefinition(
            activity_type="omnigent.harvest_evidence",
            family="omnigent_session",
            capability_class="workflow",
            task_queue=workflow_task_queue,
            fleet=WORKFLOW_FLEET,
        ...
        TemporalActivityDefinition(
            activity_type="omnigent.publish_workspace",
            family="omnigent_session",
            capability_class="workflow",
            task_queue=workflow_task_queue,
            fleet=WORKFLOW_FLEET,
        ...
        TemporalActivityDefinition(
            activity_type="omnigent.stop_provider_session",
            family="omnigent_session",
            capability_class="workflow",
            task_queue=workflow_task_queue,
            fleet=WORKFLOW_FLEET,
        ...
        TemporalActivityDefinition(
            activity_type="omnigent.stop_host",
            family="omnigent_session",
            capability_class="workflow",
            task_queue=workflow_task_queue,
            fleet=WORKFLOW_FLEET,
        ...
        TemporalActivityDefinition(
            activity_type="omnigent.release_leases",
            family="omnigent_session",
            capability_class="workflow",
            task_queue=workflow_task_queue,
            fleet=WORKFLOW_FLEET,
        ...
        TemporalActivityDefinition(
            activity_type="omnigent.persist_decision",
            family="omnigent_session",
            capability_class="workflow",
            task_queue=workflow_task_queue,
            fleet=WORKFLOW_FLEET,
        ...
        TemporalActivityDefinition(
            # Durable histories may still contain this pre-cutover activity type.
            # The handler rejects it non-retryably and never creates a sidecar.
