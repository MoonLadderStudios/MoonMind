...
Execution uses ``integration.omnigent.execute``. Poll-based hooks are not used
for the v1 streaming-gateway provider shape.
"""
...
class OmnigentExternalAdapter(BaseExternalAgentAdapter):
    """Registry entry for Omnigent streaming-gateway execution."""
...
__all__ = ["OmnigentExternalAdapter"]
