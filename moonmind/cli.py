...
def worker_doctor() -> None:
    # MoonLadderStudios/MoonMind#4112: the native vector backend is retired.
    # Doctor performs no vector network access and reports no vector probe;
    # remaining runtime prerequisite checks live in the worker preflight
