...
Moved into the Omnigent domain layer for MoonLadderStudios/MoonMind#3711; the
legacy ``moonmind.omnigent.failure_classification`` module re-exports these
symbols for compatibility with existing imports.
