...
# transport: new embedded launches, runner bindings, host lifecycle writes,
# and tunnel lookups are gone. The lifecycle key, states, and transition
# relation below stay as read-only decoding for retained session history and
# for the shared first-message idempotency transitions on recorded rows;
# retained rows drain through the janitor-owned terminal-cleanup probes.
