...
- **XII. Canonical Documentation Separates Desired State from Migration Backlog**: PASS. Long-lived docs remain declarative while cutover/playbook material stays in `docs/ManagedAgents/AgentSessionDeploymentSafetyCutover.md` (and related feature specs).
