...
- [x] T005 [US2] Emit stage execution metadata in workflow task payloads for discover/submit/publish in `moonmind/workflows/agentkit_celery/tasks.py`.
...
- [x] T008 [US1] Wire embedding readiness checks into `celery_worker/agentkit_worker.py`.
