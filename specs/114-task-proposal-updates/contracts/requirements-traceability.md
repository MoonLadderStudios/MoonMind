...
| **DOC-REQ-005** | FR-005 | `moonmind.workflows.temporal.workflows.run.py`, `MoonMind.Run` payload injection | Assure metadata assignment specifically crafts exact `origin_source="workflow"`. Tested via `test_proposal_stage` boundaries. |
