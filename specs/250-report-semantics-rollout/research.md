...
Evidence: `spec.md` (Input); `specs/250-report-semantics-rollout/spec.md`.
...
Decision: partial.
Evidence: `spec.md` (Input) and `specs/250-report-semantics-rollout/spec.md` preserve MM-497, but `plan.md`, `tasks.md`, and `verification.md` were missing at planning start.
