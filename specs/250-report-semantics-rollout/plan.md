...
| FR-007 | partial | `spec.md` and `spec.md` (Input) preserve MM-497, but downstream planning and later verification artifacts were missing at planning start. | Preserve MM-497 across plan, tasks, and verification artifacts. | traceability review |
