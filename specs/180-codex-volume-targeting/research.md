...
Decision: Use compose-backed hermetic integration coverage through `./tools/test_integration.sh # includes or is extended with tests/integration/services/temporal/test_codex_session_task_creation.py` when Docker is available.
...
Decision: Preserve in-scope source coverage IDs `DESIGN-REQ-004, DESIGN-REQ-005, DESIGN-REQ-006, DESIGN-REQ-017, DESIGN-REQ-020` and keep all other MM-318 stories out of scope for this spec.
