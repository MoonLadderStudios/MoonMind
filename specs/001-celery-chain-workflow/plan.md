...
**Storage**: PostgreSQL `spec_workflow_runs` + `spec_workflow_task_states`; Redis broker for task dispatch; object storage optional for large artifacts (initially local filesystem under `specs/.../artifacts`)  
