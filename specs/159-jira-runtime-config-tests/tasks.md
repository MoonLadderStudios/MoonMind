...
- [ ] T001 Review existing runtime config assembly and Jira rollout hooks in api_service/api/routers/task_dashboard_view_model.py and moonmind/config/settings.py
- [ ] T002 [P] Review existing runtime config unit-test patterns in tests/unit/api/routers/test_task_dashboard_view_model.py
- [ ] T003 [P] Review operator default examples in api_service/config.template.toml
...
- [ ] T004 Add or confirm safe-by-default Jira Create-page feature flag fields and normalization in moonmind/config/settings.py for DOC-REQ-001, DOC-REQ-003, DOC-REQ-004, DOC-REQ-005
- [ ] T005 Add or confirm repository config template defaults in api_service/config.template.toml for DOC-REQ-004
- [ ] T006 Add or confirm a single Jira source-template constant in api_service/api/routers/task_dashboard_view_model.py for DOC-REQ-002, DOC-REQ-004, DOC-REQ-005
...
- [ ] T007 [P] [US1] Add failing disabled-rollout omission test in tests/unit/api/routers/test_task_dashboard_view_model.py for DOC-REQ-001 and DOC-REQ-003
- [ ] T008 [P] [US1] Add failing backend-tooling separation test in tests/unit/api/routers/test_task_dashboard_view_model.py for DOC-REQ-001, DOC-REQ-003, DOC-REQ-005
- [ ] T009 [US1] Run focused failing tests with ./tools/test_unit.sh tests/unit/api/routers/test_task_dashboard_view_model.py for DOC-REQ-001, DOC-REQ-003, DOC-REQ-005

### Implementation for User Story 1

- [ ] T010 [US1] Implement disabled-state omission in api_service/api/routers/task_dashboard_view_model.py for DOC-REQ-001 and DOC-REQ-003
- [ ] T011 [US1] Preserve existing non-Jira runtime config shape in api_service/api/routers/task_dashboard_view_model.py for DOC-REQ-001 and DOC-REQ-002
- [ ] T012 [US1] Run focused passing tests with ./tools/test_unit.sh tests/unit/api/routers/test_task_dashboard_view_model.py for DOC-REQ-001, DOC-REQ-002, DOC-REQ-003, DOC-REQ-005
...
- [ ] T013 [P] [US2] Add failing enabled endpoint-template test in tests/unit/api/routers/test_task_dashboard_view_model.py for DOC-REQ-002, DOC-REQ-004, DOC-REQ-005
- [ ] T014 [P] [US2] Add failing MoonMind-API-path safety assertions in tests/unit/api/routers/test_task_dashboard_view_model.py for DOC-REQ-001 and DOC-REQ-005
- [ ] T015 [US2] Run focused failing tests with ./tools/test_unit.sh tests/unit/api/routers/test_task_dashboard_view_model.py for DOC-REQ-002, DOC-REQ-004, DOC-REQ-005

### Implementation for User Story 2

- [ ] T016 [US2] Implement enabled Jira source and system block merge in api_service/api/routers/task_dashboard_view_model.py for DOC-REQ-002, DOC-REQ-004, DOC-REQ-005
- [ ] T017 [US2] Ensure endpoint templates in api_service/api/routers/task_dashboard_view_model.py expose only MoonMind API paths and no Jira credentials or Jira domains for DOC-REQ-001 and DOC-REQ-005
- [ ] T018 [US2] Run focused passing tests with ./tools/test_unit.sh tests/unit/api/routers/test_task_dashboard_view_model.py for DOC-REQ-001, DOC-REQ-002, DOC-REQ-004, DOC-REQ-005
...
- [ ] T019 [P] [US3] Add failing configured-defaults runtime config test in tests/unit/api/routers/test_task_dashboard_view_model.py for DOC-REQ-004 and DOC-REQ-005
- [ ] T020 [P] [US3] Add failing default-normalization coverage in tests/unit/config/test_settings.py for DOC-REQ-004
- [ ] T021 [US3] Run focused failing tests with ./tools/test_unit.sh tests/unit/api/routers/test_task_dashboard_view_model.py tests/unit/config/test_settings.py for DOC-REQ-004 and DOC-REQ-005

### Implementation for User Story 3

- [ ] T022 [US3] Surface default project key, board ID, and session-memory values in api_service/api/routers/task_dashboard_view_model.py for DOC-REQ-004 and DOC-REQ-005
- [ ] T023 [US3] Ensure settings normalization for default project key and board ID in moonmind/config/settings.py for DOC-REQ-004
- [ ] T024 [US3] Run focused passing tests with ./tools/test_unit.sh tests/unit/api/routers/test_task_dashboard_view_model.py for DOC-REQ-004 and DOC-REQ-005
...
- [ ] T025 [P] Verify all DOC-REQ mappings remain complete in specs/159-jira-runtime-config-tests/contracts/requirements-traceability.md
- [ ] T026 Run runtime scope validation with ./.specify/scripts/bash/validate-implementation-scope.sh --check tasks --mode runtime
- [ ] T027 Run full unit verification with ./tools/test_unit.sh
- [ ] T028 Review final git diff for unrelated changes in api_service/api/routers/task_dashboard_view_model.py, moonmind/config/settings.py, api_service/config.template.toml, and tests/unit/api/routers/test_task_dashboard_view_model.py
