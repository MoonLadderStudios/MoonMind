# Specification Quality Checklist: Claude OAuth Runtime Launch Materialization
...
- The preserved original preset brief in `spec.md` (Input) is the canonical orchestration input for this spec.
