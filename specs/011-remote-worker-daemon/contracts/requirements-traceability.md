...
| `UMB-011-009` Codex model and effort strings are passed through verbatim to `codex exec` | `FR-011` | `moonmind/agents/codex_worker/handlers.py::_build_codex_exec_command` | `tests/unit/agents/codex_worker/test_handlers.py::test_handler_preserves_codex_model_and_effort` |
