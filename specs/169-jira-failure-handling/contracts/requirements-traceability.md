...
| DOC-REQ-002 | FR-002, FR-005, FR-006 | `api_service/api/routers/jira_browser.py`; `frontend/src/entrypoints/task-create.tsx` | Secret-redaction regression tests on browser error responses; frontend tests asserting inline browser-panel failure and empty-state copy includes manual-continuation guidance. |
