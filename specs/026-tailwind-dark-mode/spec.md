...
| DOC-REQ-008 | `docs/TaskDashboardStyleSystem.md:91` | Dark mode must keep purple as the primary accent while using yellow/orange highlights in a restrained, intentional way. |
