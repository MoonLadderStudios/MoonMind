...
| DOC-REQ-007 | `docs/TaskDashboardStyleSystem.md:764` | Dark mode must preserve readability for tables, forms, and live output surfaces. |
| DOC-REQ-008 | `docs/TaskDashboardStyleSystem.md:765` | Dark mode must keep purple as the primary accent while using yellow/orange highlights in a restrained, intentional way. |
...
| DOC-REQ-010 | `docs/TaskDashboardStyleSystem.md:727` | Phase 3 scope must include dark token overrides, theme toggle + preference persistence, and no-flash theme boot behavior. |
