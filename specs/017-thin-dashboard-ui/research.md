...
- **Decision**: Implement a frontend normalization layer (`DashboardRun`) that maps queue/orchestrator statuses to a common display status and exposes queue skill ids for AgentKit task discovery.
