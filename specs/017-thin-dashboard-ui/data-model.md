...
|------|------|-------------|
| `source` | enum (`queue` \| `orchestrator`) | Origin system for the record |
...
| Field | Type | Description |
|------|------|-------------|
| `kind` | enum (`queue` \| `orchestrator`) | Form source |
...
| Field | Type | Description |
|------|------|-------------|
| `source` | enum (`queue` \| `orchestrator`) | API source |
...
| `eventsOrTasks` | array | Queue events or orchestrator step/task timeline |
