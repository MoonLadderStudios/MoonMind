...
Decision: Use compose-backed hermetic integration coverage through `./tools/test_integration.sh # includes or is extended with tests/integration/services/temporal/workflows/test_agent_run.py` when Docker is available.
