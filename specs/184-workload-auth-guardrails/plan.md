# Implementation Plan: Workload Auth-Volume Guardrails

**Branch**: `184-workload-auth-guardrails` | **Date**: 2026-04-16 | **Spec**: `specs/184-workload-auth-guardrails/spec.md`
...
This story implements workload mount policy and managed-session identity separation. The implementation should stay inside the existing MoonMind runtime boundaries and validate behavior through TDD: focused unit tests first, then hermetic integration coverage where the behavior crosses workflow, API, Docker, or browser boundaries.
...
- Spec: `specs/184-workload-auth-guardrails/spec.md`
- Plan: `specs/184-workload-auth-guardrails/plan.md`
- Research: `specs/184-workload-auth-guardrails/research.md`
- Data model: `specs/184-workload-auth-guardrails/data-model.md`
- Contract: `specs/184-workload-auth-guardrails/contracts/workload-auth-guardrails.md`
- Quickstart: `specs/184-workload-auth-guardrails/quickstart.md`
- Likely production touchpoints: moonmind/schemas/workload_models.py, moonmind/workloads/docker_launcher.py, moonmind/workflows/temporal/artifacts.py
- Unit test targets: tests/unit/workloads/test_workload_contract.py tests/unit/workloads/test_docker_workload_launcher.py
- Integration test targets: tests/integration/services/temporal/workflows/test_agent_run.py
