...
| DOC-REQ-007 | `docs/Temporal/TemporalPlatformFoundation.md` §8 | FR-006, FR-015 | `moonmind/workflows/temporal/workers.py`, `moonmind/config/settings.py` | `T002`, `T007`, `T010`, `T038` | `T034` | Worker startup tests verify direct task-queue polling without deployment-version routing |
...
| DOC-REQ-011 | `docs/Temporal/TemporalArchitecture.md` §4, §5, §17 | FR-010, FR-015 | `moonmind/workflows/temporal/*`, `moonmind/workflows/agentkit_celery/tasks.py`, compatibility routing surfaces | `T006`, `T009`, `T011`, `T029` | `T023` | Integration tests verify Temporal-first execution ownership and activity side-effect boundaries |
