# Tasks: DooD Phase 7 Bounded Helper Containers

- [X] T001 Add Phase 7 spec, plan, and tasks under `specs/161-dood-bounded-helper-containers/`.
- [X] T002 Add failing helper contract tests in `tests/unit/workloads/test_workload_contract.py`.
- [X] T003 Add failing helper launcher/readiness/teardown tests in `tests/unit/workloads/test_docker_workload_launcher.py`.
