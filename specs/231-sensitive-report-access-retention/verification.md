...
| FR-005 | `moonmind/workflows/temporal/artifacts.py:188`; `tests/unit/workflows/temporal/test_artifacts.py:385` | VERIFIED | `report.primary` and `report.summary` default to `long` retention. |
