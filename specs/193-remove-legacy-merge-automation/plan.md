...
- XII. Canonical Documentation: PASS. Volatile orchestration input remains under `local-only handoffs`; canonical docs are updated only if they imply both workflow paths are active.
