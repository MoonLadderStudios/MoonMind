...
- [x] T001 Add failing route coverage for the remaining legacy Mission Control pages and define the new React entrypoint contract
- [x] T002 Implement React/Vite entrypoints for task create, manifest submit, and skills with focused frontend tests
- [x] T003 Cut FastAPI routing over to React-only page rendering and keep dashboard alerts mounted on React pages
