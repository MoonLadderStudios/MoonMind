...
2. `defaultTaskRuntime` resolves in order: `MOONMIND_WORKER_RUNTIME`, `settings.spec_workflow.default_task_runtime`, fallback to `supportedTaskRuntimes[0]`. Any value not in the supported list is ignored.
