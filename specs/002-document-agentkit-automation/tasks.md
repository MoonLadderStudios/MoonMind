...
- [x] T005 Implement workspace manager helpers for run/home/artifact directories in moonmind/workflows/agentkit_celery/workspace.py
- [x] T006 Add WorkflowRun-related SQLAlchemy models in moonmind/workflows/agentkit_celery/models.py
...
- [x] T008 [US1] Add workflow repository methods for run/task/artifact persistence in moonmind/workflows/agentkit_celery/repositories.py
- [x] T009 [US1] Implement job container lifecycle (start/exec/stop) using Docker SDK in moonmind/workflows/agentkit_celery/job_container.py
- [x] T010 [US1] Add branch naming and workspace preparation utilities in moonmind/workflows/agentkit_celery/workspace.py
- [ ] T011 [US1] Orchestrate specify→plan→tasks execution with container phases in moonmind/workflows/agentkit_celery/tasks.py
- [ ] T012 [US1] Implement git commit/push and PR helpers for job container runs in moonmind/workflows/agentkit_celery/tasks.py
...
- [x] T015 [US2] Expose run detail and artifact query helpers in moonmind/workflows/agentkit_celery/repositories.py
...
- [x] T019 [US3] Inject secrets as env vars and redact sensitive logs in moonmind/workflows/agentkit_celery/job_container.py
- [x] T020 [US3] Implement workspace and container cleanup routines with retention policy in moonmind/workflows/agentkit_celery/workspace.py
- [x] T021 [US3] Add agent configuration selection and persistence to moonmind/workflows/agentkit_celery/tasks.py
...
- [x] T023 Update docs/AgentKitAutomation.md with finalized architecture and operational guidance
- [x] T024 Refresh quickstart instructions and validation steps in specs/002-document-agentkit-automation/quickstart.md
- [x] T025 Document run operations and monitoring tips in specs/002-document-agentkit-automation/plan.md and AGENTS.md

---

## Phase 7: 015 Umbrella Alignment (Cross-Story)

**Purpose**: Align 002 contracts/runtime with skills-first semantics and Agentkit-always-on policy while preserving API compatibility.

- [x] T026 [P] Add skills-first compatible stage aliases and metadata normalization helpers in `moonmind/workflows/agentkit_celery/models.py`.
