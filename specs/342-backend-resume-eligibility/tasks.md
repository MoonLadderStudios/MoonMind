...
- [ ] T008 [P] Add API unit tests that Resume rejects all edited task payload field categories in `tests/unit/api/routers/test_executions.py` covering FR-009, SCN-006, SC-005, DESIGN-REQ-001, and DESIGN-REQ-005.
- [ ] T009 [P] Add Temporal service unit tests proving generic rerun and edited full retry do not carry or infer Resume metadata in `tests/unit/workflows/temporal/test_temporal_service.py` covering FR-004, SCN-004, SC-004, and DESIGN-REQ-004.
