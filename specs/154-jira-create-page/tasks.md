...
- [ ] T029 [P] [US3] Add Create-page tests for all import modes: preset brief, execution brief, description only, and acceptance criteria only in `frontend/src/entrypoints/task-create.test.tsx` (DOC-REQ-010, DOC-REQ-014)
...
- [ ] T051 [P] Run focused frontend verification `npm run ui:test -- frontend/src/entrypoints/task-create.test.tsx` and record results in `specs/154-jira-create-page/quickstart.md` if any command needs adjustment (DOC-REQ-001, DOC-REQ-002, DOC-REQ-003, DOC-REQ-004, DOC-REQ-005, DOC-REQ-009, DOC-REQ-010, DOC-REQ-011, DOC-REQ-012, DOC-REQ-013, DOC-REQ-014)
