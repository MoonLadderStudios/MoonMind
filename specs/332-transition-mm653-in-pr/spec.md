...
**Feature Branch**: `change-jira-issue-mm-653-to-status-in-pr-9a125dfc`
**Created**: 2026-05-09
**Status**: Draft
...
- The branch slug `in-pr` is a short-form for the target workflow status `In Progress`; the literal target status name is `In Progress`, consistent with how the prior MM-601 (PR #2046) and MM-652 (PR #2048) runs were aligned after review.
