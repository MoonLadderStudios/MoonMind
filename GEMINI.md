...
- Node.js 20+ (for CLI runtime), Python 3.11 (existing `api_service`) + Gemini CLI npm package (`@google` scope, `gemini-cli` name) (006-add-gemini-cli)
...
Node.js 20+ (for CLI runtime), Python 3.11 (existing `api_service`): Follow standard conventions
