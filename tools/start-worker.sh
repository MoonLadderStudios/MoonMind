...
export WORKFLOW_REPO_ROOT="${WORKFLOW_REPO_ROOT:-${WORKFLOW_REPO_ROOT:-${MOONMIND_WORKER_WORKFLOW_REPO_ROOT:-${MOONMIND_WORKER_WORKFLOW_REPO_ROOT:-$WORKSPACE_ROOT_DEFAULT}}}}"
