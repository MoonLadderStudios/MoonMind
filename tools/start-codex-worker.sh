...
export SPEC_SKILLS_LEGACY_MIRROR_ROOT="${SPEC_SKILLS_LEGACY_MIRROR_ROOT:-${MOONMIND_WORKER_SPEC_SKILLS_LEGACY_MIRROR_ROOT:-$SPEC_WORKFLOW_REPO_ROOT/.agents/skills/skills}}"
