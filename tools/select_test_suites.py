...
OMNIGENT_CONTRACT_EXACT = {
    ...
    # These modules launch MoonMind-owned containers with fixed explicit
    # limits on the deployment's Docker backend. Changes here must run the
    # container-job execution-path coverage.
