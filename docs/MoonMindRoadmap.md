...
- [x] **1.8** Universal OAuth terminal sessions — Design doc in `docs/ManagedAgents/OAuthTerminal.md` (session table, API, Mission Control terminal UI, PTY/WebSocket auth runner, provider registry)
