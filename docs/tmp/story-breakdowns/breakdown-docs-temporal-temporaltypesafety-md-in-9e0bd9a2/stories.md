...
- Story extraction date: `2026-04-14T22:56:29Z`
...
- DESIGN-REQ-019: STORY-004, STORY-005
- DESIGN-REQ-020: STORY-005
- DESIGN-REQ-021: STORY-001
...
- STORY-003: STORY-001
- STORY-004: STORY-001
- STORY-005: STORY-001, STORY-002, STORY-003, STORY-004

## Out-of-Scope Items and Rationale

- Creating or modifying `spec.md` files is out of scope for breakdown; this handoff is for later specify work.
- Creating directories under `specs/` is out of scope for breakdown; spec numbering and directories happen during `/speckit.specify`.
- Task Queue topology, retry-policy semantics, and artifact-storage architecture redesign are out of scope because the source design explicitly excludes or narrows them.
- Activity/workflow type renaming is out of scope because the source design treats those names as long-lived Temporal contracts.
