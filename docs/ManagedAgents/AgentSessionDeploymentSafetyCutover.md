...
Operator playbook for **replay-safe rollout** of durable `AgentSession` workflow changes. The deployment-integrity gate expects this file to mention the topics below when sensitive workflow paths change.
