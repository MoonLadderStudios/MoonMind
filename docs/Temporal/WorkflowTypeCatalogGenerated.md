...
| `MoonMind.OAuthCredentialValidation` <a id="moonmindoauthcredentialvalidation"></a> | `moonmind.workflows.temporal.workflows.oauth_session.MoonMindOAuthCredentialValidationWorkflow` | `operator` | [lifecycle](#moonmindoauthcredentialvalidation) |
...
| `github_issue.assess_legacy` | `integrations` | `mm.activity.integrations` |
