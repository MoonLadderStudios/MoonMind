...
- **Services to run**: `docker compose up temporal api temporal-worker-sandbox mm-orchestrator` (Temporal Server, API service, Agent Sandbox, and Orchestrator worker). Ensure PostgreSQL is reachable as the persistent store for the Temporal cluster.
