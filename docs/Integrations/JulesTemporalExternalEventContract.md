...
- legacy filesystem artifact roots such as `var/artifacts/...` remain relevant for non-Temporal Celery/orchestrator paths, but they are not the canonical backend for this contract
