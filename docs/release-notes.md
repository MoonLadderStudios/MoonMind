...
### Rollout Notes
- Disable flag: `FEATURE_FLAGS__DISABLE_TASK_TEMPLATE_CATALOG=1` (legacy fallback: `DISABLE_TASK_TEMPLATE_CATALOG=1`).
- Default is enabled; set the disable flag only when a rollback is required.
