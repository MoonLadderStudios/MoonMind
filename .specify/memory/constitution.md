<!--
Sync Impact Report
Generated by: pr-resolver workflow
Last amended: 2026-02-25
Version bump: 1.0.1 (PATCH)

- Added explicit governance metadata fields required for future amendment tracking.
- Added CLI argument precedence in runtime configuration governance.
- Tightened migration plan requirement for API breaking changes without deprecation window.
- Updated comments/feedback from PR review for traceability requirements.

Templates:
- ✅ .agents/skills/skills/speckit-constitution/SKILL.md (followed)
-->
