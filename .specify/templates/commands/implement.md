...
5. Parse tasks.md structure and extract:
   - **Task phases**: Setup, Foundational, Unit Tests, Integration Tests, Implementation, Polish, Final Verification
...
9. Completion validation:
   ...
   - Recommend `/speckit.verify` as the final check against the original feature request preserved in spec.md
