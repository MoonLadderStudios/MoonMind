...
2. **Load context**: Read FEATURE_SPEC and `AGENTS.md`. Confirm FEATURE_SPEC contains exactly one user story. Load IMPL_PLAN template (already copied).
