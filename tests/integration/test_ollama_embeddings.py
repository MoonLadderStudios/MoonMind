...
settings.ollama.ollama_embedding_model = (
...
def ollama_embeddings_instance(ollama_running):
    ...
    if not ollama_running:
        pytest.skip(
            f"Ollama is not running at {settings.ollama.ollama_base_url}. Skipping Ollama embeddings tests."
        )
...
def test_ollama_embeddings_generation_multiple_texts(ollama_embeddings_instance):
    ...
    batched_embeddings = ollama_embeddings_instance.get_text_embedding_batch(
        sample_texts
    )
