...
def mock_temporal_client_adapter(monkeypatch: pytest.MonkeyPatch):
    import uuid
    ...
    async def mock_start_workflow(*_args, **_kwargs):
        workflow_id = _kwargs.get("workflow_id") or "mm:dummy"
