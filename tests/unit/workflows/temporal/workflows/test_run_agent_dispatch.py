"""Unit tests for Phase D: step-level agent dispatch in MoonMind.Run."""
...
# ── Unit tests for helpers (no Temporal env needed) ──
...
# ── Integration test with Temporal env ──

# Mock activities for agent runtime node plan
