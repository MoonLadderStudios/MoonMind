...
def test_build_runtime_config_contains_expected_keys(monkeypatch) -> None:
    ...
    assert config["sources"]["agentRuns"]["observabilitySummary"] == "/api/agent-runs/{agentRunId}/observability-summary"
    assert config["sources"]["agentRuns"]["observabilityEvents"] == "/api/agent-runs/{agentRunId}/observability/events"
    assert config["sources"]["agentRuns"]["logsStream"] == "/api/agent-runs/{agentRunId}/logs/stream"
    assert config["sources"]["agentRuns"]["logsStdout"] == "/api/agent-runs/{agentRunId}/logs/stdout"
    assert config["sources"]["agentRuns"]["logsStderr"] == "/api/agent-runs/{agentRunId}/logs/stderr"
    assert config["sources"]["agentRuns"]["logsMerged"] == "/api/agent-runs/{agentRunId}/logs/merged"
