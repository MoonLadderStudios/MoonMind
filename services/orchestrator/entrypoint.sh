...
export WORKFLOW_REPO_ROOT="${WORKFLOW_REPO_ROOT:-${WORKFLOW_REPO_ROOT:-${MOONMIND_ORCHESTRATOR_WORKFLOW_REPO_ROOT:-${MOONMIND_ORCHESTRATOR_SPEC_WORKFLOW_REPO_ROOT:-${WORKSPACE_ROOT}}}}}"
