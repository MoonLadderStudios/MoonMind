...
export WORKFLOW_SKILLS_LOCAL_MIRROR_ROOT="${WORKFLOW_SKILLS_LOCAL_MIRROR_ROOT:-${MOONMIND_ORCHESTRATOR_WORKFLOW_SKILLS_LOCAL_MIRROR_ROOT:-${WORKFLOW_REPO_ROOT}/.agents/skills/local}}"

export WORKFLOW_SKILLS_LEGACY_MIRROR_ROOT="${WORKFLOW_SKILLS_LEGACY_MIRROR_ROOT:-${MOONMIND_ORCHESTRATOR_WORKFLOW_SKILLS_LEGACY_MIRROR_ROOT:-${WORKFLOW_REPO_ROOT}/.agents/skills}}"
