...
# Align orchestrator skill resolution with worker containers.
export WORKFLOW_REPO_ROOT="${WORKFLOW_REPO_ROOT:-${SPEC_WORKFLOW_REPO_ROOT:-${MOONMIND_ORCHESTRATOR_WORKFLOW_REPO_ROOT:-${MOONMIND_ORCHESTRATOR_SPEC_WORKFLOW_REPO_ROOT:-${WORKSPACE_ROOT}}}}}"
export SPEC_WORKFLOW_REPO_ROOT="${SPEC_WORKFLOW_REPO_ROOT:-${WORKFLOW_REPO_ROOT}}"
export WORKFLOW_SKILLS_LOCAL_MIRROR_ROOT="${WORKFLOW_SKILLS_LOCAL_MIRROR_ROOT:-${SPEC_SKILLS_LOCAL_MIRROR_ROOT:-${MOONMIND_ORCHESTRATOR_WORKFLOW_SKILLS_LOCAL_MIRROR_ROOT:-${MOONMIND_ORCHESTRATOR_SPEC_SKILLS_LOCAL_MIRROR_ROOT:-${WORKFLOW_REPO_ROOT}/.agents/skills/local}}}}"
export SPEC_SKILLS_LOCAL_MIRROR_ROOT="${SPEC_SKILLS_LOCAL_MIRROR_ROOT:-${WORKFLOW_SKILLS_LOCAL_MIRROR_ROOT}}"
export WORKFLOW_SKILLS_LEGACY_MIRROR_ROOT="${WORKFLOW_SKILLS_LEGACY_MIRROR_ROOT:-${SPEC_SKILLS_LEGACY_MIRROR_ROOT:-${MOONMIND_ORCHESTRATOR_WORKFLOW_SKILLS_LEGACY_MIRROR_ROOT:-${MOONMIND_ORCHESTRATOR_SPEC_SKILLS_LEGACY_MIRROR_ROOT:-${WORKFLOW_REPO_ROOT}/.agents/skills}}}}"
