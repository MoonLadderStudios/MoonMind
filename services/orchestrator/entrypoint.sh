...
export SPEC_WORKFLOW_REPO_ROOT="${SPEC_WORKFLOW_REPO_ROOT:-${WORKSPACE_ROOT}}"
export SPEC_SKILLS_LOCAL_MIRROR_ROOT="${SPEC_SKILLS_LOCAL_MIRROR_ROOT:-${WORKSPACE_ROOT}/.agents/skills/local}"
export SPEC_SKILLS_LEGACY_MIRROR_ROOT="${SPEC_SKILLS_LEGACY_MIRROR_ROOT:-${WORKSPACE_ROOT}/.agents/skills}"
