...
idx = content.find("async def test_run_publish_stage_pr_mode_resolves_missing_pr_base_branch_with_warning")
...
content = pattern.sub('    worker, queue, run_calls = publish_stage_test_setup\n', content)
